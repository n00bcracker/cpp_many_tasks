 ...
 ****************************************************************************/
int mySplineSnd(const double *x, const double *y, size_t n, double A, double B, double *y2) {
 ...
 ****************************************************************************/
int mySplintCube(const double *xa, const double *ya, const double *y2a, size_t n, double x,
                 double *y) {
    ...
    b = (x - xa[lo]) / dx;
    *y = a * ya[lo] + b * ya[hi] +
         ((a * a * a - a) * y2a[lo] + (b * b * b - b) * y2a[hi]) * dx * dx / 6.0;
    return 0;
}
