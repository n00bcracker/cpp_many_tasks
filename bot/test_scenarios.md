...
```bash
$ curl http://localhost:8080/bot123/getMe
{
   "ok" : true,
   "result" : {
      "username" : "test_bot",
...
```bash
$ curl -v http://localhost:8080/bot123/getUpdates
{
   "result" : [
      {
         "message" : {
...
$ curl -s -H "Content-Type: application/json" -X POST -d '{"chat_id": 104519755, "text": "Hi!"}' http://localhost:8080/bot123/sendMessage | json_pp
{
   "result" : {
      "message_id" : 15,
      "text" : "Hi!",
...
$ curl -s -H "Content-Type: application/json" -X POST -d '{"chat_id": 104519755, "text": "Reply", "reply_to_message_id": 2}' http://localhost:8080/bot123/sendMessage | json_pp
{
   "result" : {
      "date" : 1510523244,
      "chat" : {
...
```bash
$ curl http://localhost:8080/bot123/getUpdates
{
   "result" : [
      {
         "message" : {
...
$ curl 'http://localhost:8080/bot123/getUpdates?offset=851793508&timeout=5'
{
   "result" : [ ],
   "ok" : true
}
